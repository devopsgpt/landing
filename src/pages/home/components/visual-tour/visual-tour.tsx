...
const VisualTour: FC = () => {
  return (
    <section className="bg-vignette-radial py-8 md:py-16">
      <div className="container mx-auto mb-10 w-full lg:mb-24">
        <div className="flex flex-col items-center justify-center">
          <p className="rounded-3xl border border-gray-500 bg-accent/10 px-6 py-1 text-accent">
            Visual Tour
          </p>
          <h2 className="mt-10 w-full bg-services-text bg-clip-text text-center text-5xl font-semibold leading-tight text-transparent md:text-[64px] lg:w-1/2">
            Simplify DevOps with Templates and Automation
          </h2>
          <p className="mt-4 w-full text-center text-accent-dark md:w-1/2 lg:w-1/4">
            See how our app makes DevOps tasks easier. automate workflows, and
            simplify your processes with just a few clicks
          </p>
        </div>
      </div>
      <div className="mb-14 grid w-full grid-cols-1 items-center justify-center gap-4 lg:grid-cols-2">
